...
* PROJ [#A] Create a project with abm and make
- Write a simple project combining the following tools:
  - Make
  - Julia
    - use agents.jl + drwatson.jl + parameters.jl
    - use tools for analysis such as design matrices and saltelli method
  - Latex
    - (use some beautiful template)
  - Maybe Org
  - Emacs (projectile)

* PROJ [#C] Create an org headline extractor
- Mix elisp and python for that
- There is julia too: [[https://github.com/non-Jedi/Org.jl][GitHub - non-Jedi/Org.jl: Hacky org-mode parser in Julia]]
...
#+RESULTS: block1
: /home/mvmaciel/Drive/Org/org-roam-mvm/20200702062139-techniques_refs.org

#+RESULTS: block-1
: /home/mvmaciel/Drive/Org/org-roam-mvm/20200702062139-techniques_refs.org

#+name: block2
#+BEGIN_SRC python :results output :var here=block1
from orgparse import load
root = load(here)
#print(dir(root))

[print(child.get_heading()) for child in root.children]
...
#+BEGIN_SRC julia  :results output :var fpy=block2
print(fpy)
#+END_SRC
